...
def _tab_performance(tabular: Dict, t: Dict) -> None:
    ...
    if metrics:
        st.plotly_chart(_model_comparison_chart(metrics, t), use_container_width=True)
    ...
    if feat_imp is not None:
        st.plotly_chart(_feature_importance_chart(feat_imp, t), use_container_width=True)
    else:
